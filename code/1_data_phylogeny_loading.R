...
# Purpose: Load and preprocess trait metadata, covariates, parameter estimates,
#          and phylogenetic trees for analysis
# Author: Adrian Stier
# Date: 2025-07-08
###############################################################################
...
params_primary <- read.csv(here::here("output", "combined_results_2024-09-17.csv")) %>%
  dplyr::select(
    substudy_num,
    alpha,
    beta,
...
readr::write_csv(
  all_dat2,
  here::here("output", "merged-covariates-10-21-24.csv"),
  na = ""
)
